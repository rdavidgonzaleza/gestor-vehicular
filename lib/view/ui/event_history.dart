...
class Event {
  ...
  final List<String> documents; // Lista de documentos
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemCount: events.length, // Usamos el número real de eventos
                itemBuilder: (context, index) {
                  final event = events[index]; // Obtener evento
                  return Container(
                    padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 5),
